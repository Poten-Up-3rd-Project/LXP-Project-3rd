...
public class UserProfile extends AggregateRoot<UserProfileId> {
    ...
    private UserProfile(UserProfileId id, UserId userId, Level level, Tags tags, String job) {
    ...
    public static UserProfile create(UserProfileId id, UserId userId, Level level, Tags tags, String job) {
